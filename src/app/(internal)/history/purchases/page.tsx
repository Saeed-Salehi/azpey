...
import { loadPurchaseHistory } from "@/lib/storage/history";
...
export default function PurchaseHistoryPage() {
  ...
  React.useEffect(() => {
    setLines(loadPurchaseHistory());
  }, []);

  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-2xl font-bold sm:text-3xl">تاریخچه خرید</h1>
        <p className="text-sm text-muted-foreground sm:text-base">
          فهرست اقلام و محصولاتی که خریداری کرده‌اید
        </p>
      </div>
